...
依附于[第13章](../13/13.0.md)模式的描述和[第17.1小节](../17/17.1.md)与[第17.2.4小节](../17/17.2.md)的总结。
...
这种方法可以很容易分辨出错误检测、错误通知和正常的程序逻辑（更详细的方式参考[第13.5小节](../13/13.5.md)）。

**在开始阅读[第17章](../17/17.0.md)前，先回答下列2个问题：**

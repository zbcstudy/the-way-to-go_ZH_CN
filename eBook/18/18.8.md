...
（6）如何限制并发处理请求的数量：参考[章节14.11](../14/14.11.md)

（7）如何在多核CPU上实现并行计算：参考[章节14.13](../14/14.13.md)
...
（11）如何在同步调用运行时间过长时将之丢弃：参考[章节14.5](../14/14.5.md) 第二个变体

（12）如何在通道中使用计时器和定时器：参考[章节14.5](../14/14.5.md)

（13）典型的服务器后端模型：参考[章节14.4](../14/14.4.md)
